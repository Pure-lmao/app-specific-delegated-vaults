...
$PrimaryBench = @(
   ...
   @{ op = "app_ix_inner_0_accounts"; label = "app_ix::app_ix_inner_bench_0_accounts" },
   @{ op = "app_ix_inner_1_account"; label = "app_ix::app_ix_inner_bench_1_account" },
   @{ op = "app_ix_inner_50_accounts"; label = "app_ix::app_ix_inner_bench_50_accounts" },
